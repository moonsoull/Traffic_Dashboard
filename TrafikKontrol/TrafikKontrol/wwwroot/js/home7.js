	...
	$.ajax({
		...
		success: function (response) {
			response.forEach(obj => {
				...
				var ctx = document.getElementById('doughnut-chart7').getContext('2d');
				var chart = new Chart(ctx, {
					// The type of chart we want to create
...
function chart4() {
	...
	$.ajax({
		...
		success: function (response) {
			...
			var ctx = document.getElementById('bar-chart-horizontal7').getContext('2d');
			var chart = new Chart(ctx, {
				// The type of chart we want to create
...
function chart5() {
	...
	$.ajax({
		...
		success: function (response) {
			...
			var ctx = document.getElementById('bar-chart-horizontal7_1').getContext('2d');
			var chart = new Chart(ctx, {
				// The type of chart we want to create
				type: 'horizontalBar', // also try bar or other graph types
