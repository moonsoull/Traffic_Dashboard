		...
		success: function (response) {
			...
			var chart = new Chart(ctx, {
				...
				options: {
					...
					title: {
						display: true,
						text: 'Araç Yönü Toplam Sayı Grafiği'
					},
				}
			});
		},
...
function chart2() {
	...
	$.ajax({
		...
		success: function (response) {
			...
			var ctx = document.getElementById('doughnut-chart8').getContext('2d');
			var chart = new Chart(ctx, {
				// The type of chart we want to create
...
function chart4() {
	...
	$.ajax({
		...
		success: function (response) {
			...
			var ctx = document.getElementById('bar-chart-horizontal8').getContext('2d');
			var chart = new Chart(ctx, {
				// The type of chart we want to create
...
function chart5() {
	...
	$.ajax({
		...
		success: function (response) {
			...
			var ctx = document.getElementById('bar-chart-horizontal8_1').getContext('2d');
			var chart = new Chart(ctx, {
				// The type of chart we want to create
				type: 'horizontalBar', // also try bar or other graph types
...
function chart6() {
	...
	$.ajax({
		...
		success: function (response) {
			...
			var ctx = document.getElementById('bar-chart-horizontal8_2').getContext('2d');
			var chart = new Chart(ctx, {
				// The type of chart we want to create
				type: 'horizontalBar', // also try bar or other graph types
...
function chart7() {
	...
	$.ajax({
		...
		success: function (response) {
			...
			var ctx = document.getElementById('bar-chart-horizontal8_3').getContext('2d');
			var chart = new Chart(ctx, {
				// The type of chart we want to create
				type: 'horizontalBar', // also try bar or other graph types
